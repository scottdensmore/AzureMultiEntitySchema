...
namespace AExpense.AspProviders
{
    public class TableStorageRoleProvider : RoleProvider
    {
        ...
        public override void AddUsersToRoles(string[] usernames, string[] roleNames)
        {
            ...
            try
            {
                ...
                foreach (string role in roleNames)
                {
                    ...
                    {
                        var row = new RoleRow(_applicationName, role, user);
                        try
                        {
        ...
        public override void CreateRole(string roleName)
        {
            ...
            {
                TableServiceContext svc = CreateDataServiceContext();
                var newRole = new RoleRow(_applicationName, roleName, string.Empty);
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            ApplicationName = ProviderConfiguration.GetStringValueWithGlobalDefault(config, "applicationName",
            ...
            _tableName = ProviderConfiguration.GetStringValueWithGlobalDefault(config, "roleTableName",
                                                                               ProviderConfiguration.DefaultRoleTableNameConfigurationString,
                                                                               ProviderConfiguration.DefaultRoleTableName, false);
            ...
            try
            {
                ...
                TableStorageExtensionMethods.CreateTableIfNotExist<RoleRow>(_tableStorage, _tableName);
            }
            ...
            catch (Exception e)
            {
                if (account != null)
                {
                    string exceptionDescription = ProviderConfiguration.GetInitExceptionDescription(account.Credentials, account.TableEndpoint, "table storage configuration");
