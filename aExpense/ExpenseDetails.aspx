...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder" runat="server">
        ...
        <p>
            ...
            <asp:GridView Width="85%" ID="ExpenseItemsGridView" runat="server" 
                ...
                <Columns>        
                    ...
                    <asp:TemplateField HeaderText="Receipt" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <a href="#" onclick="javascript:showImage('<%# Eval("ReceiptUrl") == null ? "#" : ((Uri) Eval("ReceiptUrl")).OriginalString %>')" >
                                <img src="<%# Eval("ReceiptThumbnailUrl") == null ? "#" : ((Uri) Eval("ReceiptThumbnailUrl")).OriginalString %>" alt="(receipt)" />
                            </a>                            
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
    ...
    <div id="receipt_dialog" title="Dialog Title">
		<img id="receipt_image" src="#" alt="(receipt)" />
	</div>
</asp:Content>
